    ...
    <section id="vision" className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden min-h-screen flex items-center">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <motion.div whileHover={{ y: -5 }} className="group flex flex-col items-center p-8 bg-white/5 rounded-2xl border border-white/10 hover:border-yellow-500/50 hover:bg-white/10 transition-colors duration-300 hover:shadow-lg hover:shadow-yellow-500/10">
