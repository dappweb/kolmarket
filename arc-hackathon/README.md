...
Primary track: DeFi / programmable money.

KOLMarket uses stablecoin-native rails for campaign budgets, reward workflows, and creator-token market infrastructure.

Secondary track: Agentic Economy.

Creator campaigns can evolve into agent-assisted campaign planning, KOL task routing, automated creator rewards, and USDC-native task settlement.
...
This repository/package describes an Arc Testnet pilot.
...
Those claims require official-channel evidence.
